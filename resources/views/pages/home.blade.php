...
@section('content')
	...
	<h1 class="text-center mb-5">Tous les Produits</h1>
			...
			<div class="row">
				@foreach($products as $product)
					<div class="col-md-4 mb-4">
						<div class="card" style="width: 18rem;">
							<img src="{{$product->image}}" class="card-img-top w-100" height="200px" alt="...">
							<div class="card-body">
						    	<h5 class="card-title">{{ $product->name }}</h5>
						    	<p>Vandeur: {{ $product->user->name }}</p>
						    	<div class="row">
						    		<div class="col-md-6">
						    			<h3>{{ $product->price }}<br>DH</h3>
						    		</div>
						    		<div class="col-md-6">
